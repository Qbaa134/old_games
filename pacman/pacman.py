...
BoardPath = "Rozszerzenia/BoardImages/"
ElementPath = "Rozszerzenia/ElementImages/"
TextPath = "Rozszerzenia/TextImages/"
DataPath = "Rozszerzenia/Data/"
MusicPath = "Rozszerzenia/Music/"
...
originalGameBoard = numpy.asarray(originalGameBoard, dtype="int8")
gameBoard = numpy.asarray(copy.deepcopy(originalGameBoard), dtype="int8")
spriteRatio = 3/2
square = 25 
...
def text_on_screen(content, font):
    ''' shows the text argument '''
...
class Game:
    ...
    def render(self):
        ...
        self.pacman.draw()
        # Updates the screen
        # fps = f"Frame rate: {clock.get_fps()}"
        # text_on_screen(fps, fps_font)# call the function to blit fps
        clock.tick(60)
        # pygame.display.update()
    ...
    def touchingPacman(self, row, col):
        ''' check if the row and col of ghosts are the same of pacman touches pacman '''
